define(['dart_sdk', 'packages/vivek_portfolio/main'], function(dart_sdk, packages__vivek_portfolio__main) {
  'use strict';
  ...
  const main = packages__vivek_portfolio__main.main;
  ...
  dart.trackLibraries("packages/vivek_portfolio/main_web_entrypoint", {
    "package:vivek_portfolio/main_web_entrypoint.dart": main_web_entrypoint
  }, {
